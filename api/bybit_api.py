...
if __name__ == '__main__':
    ...
    # Do Test in main.py
    # Bybit
    #テスト1：Bybitクラスのインスタンス動作確認
    # import settings
    # from api.bybit_api import Bybit
    # bybit = Bybit(
    #     account_key = settings.ak_bybit,
    #     api_secret = settings.as_bybit,
    #     bybit_end_point = settings.bybit_end_point
    # )
    # print(bybit.account_key)
    # print(bybit.api_secret)
    # print(bybit.client.orderbook(symbol='BTCUSDT'))
    
    # テスト2 : get_past_tickerの動作確認
    # from utils.timestamp import generate_timestamp_before_time_delta
    # target_timestamp = generate_timestamp_before_time_delta()
    # ticker = bybit.get_past_ticker(product_code = 'BTCUSDT', target_timestamp = target_timestamp)
    ...
    # ticker = bybit.get_realtime_ticker(product_code = 'BTCUSDT')
    # print(ticker.product_code)
    # print(ticker.price)
    # print(ticker.timestamp)
    
    # テスト4 : open_tradeの動作確認
    # trade = bybit.open_trade(product_code = 'BTCUSDT', side_of_bybit = False)
    ...
    # テスト５: close_tradeの動作確認
    # trade = bybit.close_trade(product_code = 'BTCUSDT')
    # print(trade.is_successed)
    # print(trade.product_code)
    # print(trade.side)
    # print(trade.price)
